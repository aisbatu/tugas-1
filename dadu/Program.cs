...
namespace dadu
{
    class dadu
    {
        ...
        {
            Console.WriteLine("TEBAK DADU\nanda dan komputer akan melakukan permainan 10 ronde\nanda dan komputer akan saling melempar dadu\nyang mendapat angka tertiggi akan menjadi pemenangnya\npermainan dimulai");
        }
